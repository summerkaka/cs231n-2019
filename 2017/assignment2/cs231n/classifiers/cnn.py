...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        #pass
        # cache = {}
        # data_input, cache[0] = conv_relu_pool_forward(X, W1, b1, conv_param, pool_param)
        # data_input, cache[1] = affine_relu_forward(data_input, W2, b2)
        # data_input, cache[2] = affine_forward(data_input, W3, b3)
        # loss, dx = softmax_loss(data_input, y)
        #from github
